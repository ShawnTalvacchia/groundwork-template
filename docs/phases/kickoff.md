...
- [ ] **Delete KICKOFF.md and CHANGELOG.md** — KICKOFF.md's durable notes already live in their homes (`implementation/shipping.md`, `implementation/system-surface.md`, `app/globals.css`, your CLAUDE.md Stack block), and the changelog is the template's, read at its own repo where `docs/upstream.md` points. The template leaves no onboarding behind.
